...
import CommodityTreeSelectWithPerformance from "../CommodityTreeSelectWithPerformance"
...
export default function OrderItemDialogWithPerformance({
  open,
  onOpenChange,
  isEditing,
  currentItem,
  ...
  return (
    <Dialog open={open} onOpenChange={(isOpen) => {
      ...
      <DialogContent>
        <DialogHeader>
          <DialogTitle>
            {isEditing ? 'Edit Order Item' : 'Add New Order Item'} (Performance Test)
          </DialogTitle>
          <DialogDescription>
            {isEditing
